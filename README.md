# My [AniList](https://anilist.co/user/April/) CSS
...
## Credits:
Other than Bays, I have [@ChriSenpai](https://anilist.co/user/ChriSenpai/) and [@Adaptz](https://anilist.co/user/Adaptz/) to thank for my CSS. ChriSenpai for some of the actual coding, Adaptz for design inspiration (current CSS is different now though). Under my [Current CSS](https://github.com/pinkazoid/My-CSS/blob/main/Current%20CSS), I left notes to show which of the coding came from ChriSenpai. 
